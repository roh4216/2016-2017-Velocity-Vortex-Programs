...
@TeleOp(name="CompDriveNo Encoders", group="OpMode")
@Disabled

public class CompDriveNoEncoder extends OpMode {
    ...
    public void init() {
        ...
        colorCreader = new I2cDeviceSynchImpl(colorC, new I2cAddr(0x60), false);
        ...
        motorLeftFly.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        motorRightFly.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);

        colorAcache = colorAreader.read(0x04, 1);
        colorBcache = colorBreader.read(0x04, 1);
        colorCcache = colorCreader.read(0x04, 0);
        ...
        //你好。我会说中文。你不会说中文。我喜欢吃很多😂
        //👅
        //wo xihuan shi xia le henduo heigui
    ...
    public void loop() {
        ...
        float rightpower = gamepad1.right_stick_y / driveFactor;
        float leftpower = gamepad1.left_stick_y / driveFactor;
        ...
        //Collection Commands
        if (gamepad1.a) {
            motorCollect.setPower (-0.5);//hi hailey and joe how are you guys doin????
       }
        if (gamepad1.b) {
            motorCollect.setPower (0);
        }
